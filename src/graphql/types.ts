...
export type FarcasterUserDetailsQuery = { Socials: { Social: Array<{ profileName: string | null, followerCount: number | null, followingCount: number | null }> | null } | null };

export type PurpleDaoFriendsQueryVariables = Exact<{
  farcasterUser: Scalars['Identity']['input'];
}>;


export type PurpleDaoFriendsQuery = { TokenBalances: { TokenBalance: Array<{ owner: { socialFollowings: { Following: Array<{ followingAddress: { socials: Array<{ profileName: string | null, userId: string | null, profileImageContentValue: { image: { medium: string | null } | null } | null }> | null } | null }> | null } | null } }> | null } | null };

export type MyQueryQueryVariables = Exact<{
  upFid: Scalars['String']['input'];
  downFid: Scalars['String']['input'];
}>;


export type MyQueryQuery = { up: { Social: Array<{ profileName: string | null, profileImageContentValue: { image: { medium: string | null } | null } | null }> | null } | null, down: { Social: Array<{ profileName: string | null, profileImageContentValue: { image: { medium: string | null } | null } | null }> | null } | null };
