...
async function getResponse(req: NextRequest) {
  ...
  const frame: Frame = {
    version: "vNext",
    image: `${process.env.NEXT_PUBLIC_HOSTNAME}/api/image/frame/purple-dao?fid=${fid}&page=${page}`,
    buttons: [
      {
        action: "post",
        label: `Next`,
    ...
    ogImage: `${process.env.NEXT_PUBLIC_HOSTNAME}/api/image/frame/purple-dao?fid=${fid}&page=${page}`,
